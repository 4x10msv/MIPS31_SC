...
#
# Generated by export_simulation on Fri Jun 19 10:46:12 +0800 2020
#
################################################################################
...
switch to the './IPIRAM.sh' script.
...
./IPIRAM.sh -noclean_files

For more information on the script, please type './IPIRAM.sh -help'.
